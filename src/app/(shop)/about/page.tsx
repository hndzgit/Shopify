      ...
      <article className="max-w-4xl mx-auto px-6 space-y-32">
        ...
        <section className="relative">
          ...
          >
            ...
            <img src="https://images.pexels.com/photos/163100/circuit-board-computer-technology-163100.jpeg?auto=compress&cs=tinysrgb&w=2000" alt="Tech" className="w-full h-full object-cover absolute inset-0 z-0" />
          </motion.div>
        ...
        <section className="relative">
          ...
          >
             ...
             <img src="https://images.pexels.com/photos/842554/pexels-photo-842554.jpeg?auto=compress&cs=tinysrgb&w=2000" alt="Innovation" className="w-full h-full object-cover absolute inset-0 z-0" />
          </motion.div>
